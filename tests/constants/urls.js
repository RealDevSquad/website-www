export const APPS = {
  ...
  PROFILE: 'https://realdevsquad.com/profile',
  TASKS: 'https://status.realdevsquad.com/tasks',
  IDENTITY: 'https://realdevsquad.com/identity',
  MY_STATUS: 'https://realdevsquad.com/status',
